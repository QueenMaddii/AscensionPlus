...
import static ascensionplus.AscensionPlusMain.powerPath;
import static ascensionplus.AscensionPlusMain.resourcePath;
...
public class TextureLoader {
        ...
        if (textures.get(filePath) == null) {
            try {
                ...
                try
                {
                    ...
                    AscensionPlusMain.logger.info("missing.png is missing!");
                    return null;
                }
            }
        }
    ...
    private static void loadTexture(final String textureString, boolean linearFilter) throws GdxRuntimeException {
        ...
        AscensionPlusMain.logger.info("Loaded texture " + textureString);
